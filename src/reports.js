  ...
  <body>
    <div class="container">
      <div class="header">
        ...
        <h4>Generated by QuantStats.js — dark interactive tearsheet</h4>
      </div>
      <div class="content">
        <div id="left">
          <div class="chart" id="chart_cumulative"></div>
          <div class="chart" id="chart_log"></div>
          ${normalizedBenchmark ? '<div class="chart" id="chart_rollingBeta"></div>' : ''}
          <div class="chart" id="chart_eoy"></div>
          <div class="chart" id="chart_monthlyDist"></div>
          <div class="chart" id="chart_daily"></div>
          <div class="chart" id="chart_rollingVol"></div>
          <div class="chart" id="chart_rollingSharpe"></div>
          <div class="chart" id="chart_rollingSortino"></div>
          <div class="chart tall" id="chart_ddPeriods"></div>
          <div class="chart" id="chart_underwater"></div>
          <div class="chart" id="chart_heatmap" style="height:${heatH}px"></div>
          <div class="chart" id="chart_quantiles"></div>
        </div>
        <div id="right">
          ${generateHero(performanceMetrics)}
          <h3>Key Performance Metrics</h3>
          ${generateMetricsSections(performanceMetrics, benchmarkMetrics, benchmarkTitle)}
          <div id="eoy">
